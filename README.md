...
# IL2X (NOTE: CS2X will probably be a focus)
...
NOTE: <a href="https://github.com/reignstudios/CS2X.Old">CS2X.Old</a> will be for GPU targets<br>
NOTE: <a href="https://github.com/reignstudios/CS2X">CS2X</a> This will probably be the only focused compiler
